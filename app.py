...
REGION_COLOURS = {
    "Sub-Saharan Africa":        "#E07B39",
    "North Africa & Middle East":"#C9AB82",
    "South Asia":                "#5B8DB8",
    "East Asia & Pacific":       "#2E7D8C",
    "Europe & Central Asia":     "#6A4C93",
    "Latin America & Caribbean": "#3D8B5E",
    "North America":             "#B5446E",
    "Other":                     "#AAAAAA",
}
...
def load_data():
    ...
    num_cols = [
        "elec_access","clean_cooking","renew_share","fossil_twh","renew_twh",
...
st.markdown(
    ...
    "The global electricity access gap - who is still in the dark, what drives progress, "
...
col4.metric("Years of Data",              "2000 - 2020",                 delta=None)
...
fig_map.update_layout(
    ...
    geo=dict(showframe=False, showcoastlines=True,
             coastlinecolor="#CCCCCC", bgcolor="#FAFAFA"),
)
...
fig_dark.add_vline(
    x=50, line_dash="dot", line_color="#C1440E",
...
st.caption(
    "Each bubble is a country in the selected year. X-axis is GDP per capita (log scale), "
...
st.caption(
    ...
    "Built with Streamlit and Plotly  |  UC3DVS10 Data Visualisation  |  Ceazar Jay Mamburam"
)
